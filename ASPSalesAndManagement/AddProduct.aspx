<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="ASPSalesAndManagement.AddProduct" %>
  ...
  <div class="row">
    ...
    <div class="col-md-6 login" >
	    ...
	    <div class="form-group">
			<label><b>Create a New Product</b></label>
		</div>
          <div class="form-group">
